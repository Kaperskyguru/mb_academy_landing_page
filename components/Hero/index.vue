<template>
  ...
  >
    <header class="w-full container absolute top-0 mt-5 ml-10 pl-5 pt-5">
    ...
    <div class="container relative mx-auto">
      <div
        class="-mx-4 px-2 flex flex-col gap-5 md:flex-row justify-center items-center"
      >
        <div class="w-full px-4">
          <div
            class="wow fadeInUp max-w-[800px] text-cener"
            data-wow-delay=".2s"
          >
            <h1
            ...
            >
              Take the first step toward a thriving career in backend
              engineering with Masteringbackend Academy. Masteringbackend
              bootcamp grads get hired at companies like Salesforce, Razorpay,
              and SentinelOne.
            </p>
            <div class="flex w-3/4">
              ...
              >
                <a
                  ...
                  class="relative h-10 w-full opacity-70 grayscale transition hover:opacity-100 hover:grayscale-0 dark:opacity-60 dark:hover:opacity-100"
                >
                  <img :src="brand.image" :alt="brand.name" class="w-full" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div
          class="shadow border-2 bg-white z-20 p-5 lg:mr-20 mr-0 border-primary rounded-lg mx-auto max-w-[800px]"
        >
          <h2 class="text-lg font-bold">
            Find the right Masteringbackend Academy bootcamp for you.
          </h2>
          ...
          >
            <div class="w-full">
              ...
              >
                I'm interested in Masteringbackend Academy for:
              </h4>
              <div class="mb-8 flex flex-col">
                <div class="flex gap-1">
                  <input id="myself" name="type" type="radio" class="" />
                  <label class="form-check-label" for="myself">Myself</label>
                </div>
                <div class="flex gap-1">
                  <input id="mycompany" name="type" type="radio" class="" />
                  <label class="form-check-label" for="mycompany"
                    >My Company</label
                  >
                </div>
              </div>
