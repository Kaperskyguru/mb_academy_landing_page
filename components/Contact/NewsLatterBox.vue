...
<template>
  <div
    class="wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 rounded-sm bg-white p-8 sm:p-11 lg:p-8 xl:p-11"
    data-wow-delay=".2s"
  >
    <h3
      class="mb-4 text-2xl font-bold leading-tight text-black dark:text-white"
    >
      Subscribe to "Backend Weekly" Newsletter
    </h3>
    <p
      class="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25"
    >
      Explain complex concepts in Backend Engineering, sharing exclusive backend
      engineering resources, and helping you become a great Backend Engineer.
    </p>
    <div>
      <div class="py-5 w-full">
        <iframe
          src="https://embeds.beehiiv.com/6bfdb6e8-d50a-4310-bb84-bafc8066a647?slim=true"
      ...
      <p
        class="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color"
      >
    ...
    <div>
      <span class="absolute left-2 top-7">
        <svg
          width="57"
          height="65"
          viewBox="0 0 57 65"
      ...
      <span class="absolute bottom-24 left-1.5">
        <svg
          width="39"
          height="32"
          viewBox="0 0 39 32"
      ...
      <span class="absolute right-2 top-[140px]">
        <svg
          width="38"
          height="38"
          viewBox="0 0 38 38"
